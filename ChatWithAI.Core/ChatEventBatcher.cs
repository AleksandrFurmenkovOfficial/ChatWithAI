...
namespace ChatWithAI.Core
{
        ...
        ILogger logger) : IChatProcessor, IDisposable
    {
        ...
        {
            // Этот метод теперь занимается ТОЛЬКО созданием и логированием.
            // Он ничего не знает про _chatCache.
            try
            {
            ...
            {
                // Логируем ошибку здесь, пока контекст ошибки "свежий"
                ...
                // ОБЯЗАТЕЛЬНО пробрасываем ошибку наверх.
                // Это заставит lazyTask перейти в состояние Faulted
                // и сработает catch в методе GetOrCreateChatAsync.
                throw;
            }
        }

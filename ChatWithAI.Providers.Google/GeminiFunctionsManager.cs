...
{
    internal sealed class GeminiFunctionsManager(IMemoryStorage memoryStorage, IHttpClientFactory httpClientFactory) : AiFunctionsManager(memoryStorage, httpClientFactory)
    {
